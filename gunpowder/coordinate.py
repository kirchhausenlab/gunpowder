...
class Coordinate(tuple):
    ...
    def __add__(self, other):
        ...
        assert isinstance(other, tuple), f"can only add Coordinate or tuples to Coordinate. {other} is invalid"
    ...
    def __sub__(self, other):
        ...
        assert isinstance(other, tuple), f"can only subtract Coordinate or tuples to Coordinate. {other} is invalid"
